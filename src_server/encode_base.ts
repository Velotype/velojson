import { acquireWriter, type ByteWriter, releaseWriter } from "./byte_writer.ts"
import { getWireType, HOMOGENEOUS_DETECTION_MIN_LENGTH, type JSONValue, WireType } from "./common.ts"
import { getKeyBytes } from "./key_cache.ts"
...
export function encodeValue_base_format(writer: ByteWriter, key: string | null, value: JSONValue, isInArray: boolean): void {
